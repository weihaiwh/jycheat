/**
 * v85 - 纯v71代码 + MSHookFunction替代DobbyHook
 * v84仍有卡住问题: 皮肤应用+大招卡住
 * v85策略: 逐字复制v71代码, 只改3处:
 *   1. #include "dobby.h" -> #include "substrate.h"
 *   2. DobbyHook(fa,hf,of) -> MSHookFunction(fa,hf,of)
 *   3. 版本号 v71 -> v85
 * v71是唯一确认稳定的版本, 任何其他改动都可能是卡住的原因
 */
...
static void setupUI(void){
    ...
    UILabel *tl=[[UILabel alloc]initWithFrame:CGRectMake(10,6,g_panelW-20,20)];tl.text=@"\xe5\x89\x91\xe5\xbd\xb1\xe6\xb1\x9f\xe6\xb9\x96 v85";tl.textColor=IMGUI_ACCENT;tl.font=[UIFont boldSystemFontOfSize:15];tl.textAlignment=NSTextAlignmentCenter;[tb addSubview:tl];
