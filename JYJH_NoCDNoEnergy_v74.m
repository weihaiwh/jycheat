/**
 * v74 - iOS纯功能版 (无反检测)
 * 越狱设备装了Shadow, 不需要反检测hook
 * 去掉所有dyld/getenv/task_info/dlopen/dlsym/access/fopen/NSProcessInfo/NSFileManager hook
 * constructor直接启动: findIL2CPP -> applyAllHooks -> setupUI
 */
...
static void initialize(void){
    ...
    jlog(@"========== JYJH v74 (no anti-detect) ==========");
    jlog(@"iOS %@",[[UIDevice currentDevice] systemVersion]);
    // v74: 无反检测, Shadow处理越狱隐藏
