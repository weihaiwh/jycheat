/**
 * v83 - 用 MSHookFunction (CydiaSubstrate) 替代 DobbyHook
 * v82测试: 菜单能出来, 但所有DobbyHook调用都闪退
 * 原因: Dobby在iOS 15.6 + TrollStore环境下无法正常inline hook
 * 解决: 改用CydiaSubstrate的MSHookFunction (设备上已有)
 * 编译: 不链接libdobby.a, 用-Wl,-undefined,dynamic_lookup让MSHookFunction运行时解析
 */
...
static void initialize(void){
    ...
    jlog(@"========== JYJH v83 (MSHookFunction, lazy hook) ==========");
